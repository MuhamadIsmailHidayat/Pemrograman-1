...
public class CaseOver {
	public static void main (String [] args) {
		...
		System.out.println("Penjelasan definisi dan contoh dari :");
		...
		switch(menu){
			case 1 : System.out.println("-------------------------------------------------------------------------");
					 System.out.println("DEFINISI OVERLOADING : ");
					 System.out.println("");
			...
			case 2 : System.out.println("--------------------------------------------------------------------------");
					 System.out.println("DEFINISI OVERRIDING : ");
					 System.out.println("");
					 ...
					 System.out.println("");
					 System.out.println("CONTOH PROGRAM OVERRIDING : ");
					 System.out.println("");
